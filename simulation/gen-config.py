...
TRACE_OUTPUT_FILE out/mix_{topo}_{trace}_{cc}{failure}.tr
FCT_OUTPUT_FILE out/fct_{topo}_{trace}_{cc}{failure}.txt
PFC_OUTPUT_FILE out/pfc_{topo}_{trace}_{cc}{failure}.txt
...
if __name__ == "__main__":
    ...
    print("Genrated new config file: ", config_name)
